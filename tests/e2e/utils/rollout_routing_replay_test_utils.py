...
def check_routing_replay_chat_completion(openai_client, moe_layer_num: int, model_name: str):
    ...
    if model_path:
        baseline_path = os.path.join(model_path, f"R3_BaseLine_24_uint8/routing_replay_output_baseline_{model_name}")
    else:
        baseline_path = f"./R3_BaseLine_24_uint8/routing_replay_output_baseline_{model_name}"
    stream_baseline_path = os.path.join(baseline_path, "r3_chat_completion_stream")
